...
// the diff. Source: starc007/ui-components (lib/themes.ts +
// lib/theme-css.ts). oklch values are precomputed to sRGB here; raw
// hex / rgb() literals pass through unchanged. See tool/generate_colors.dart.
//
// ignore_for_file: lines_longer_than_80_chars

part of 'beui_colors.dart';

// ── Neutral base — light ─────────────────────────────────────────
const Color _lBackground = Color(0xFFFCFCFC); // oklch(99% 0 0)
const Color _lForeground = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lCard = Color(0xFFF5F5F5); // oklch(97% 0 0)
const Color _lCardForeground = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lPopover = Color(0xFFF5F5F5); // oklch(97% 0 0)
const Color _lPopoverForeground = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lPrimary = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lPrimaryForeground = Color(0xFFFCFCFC); // oklch(99% 0 0)
const Color _lSecondary = Color(0xFFF5F5F5); // oklch(97% 0 0)
const Color _lSecondaryForeground = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lMuted = Color(0xFFF5F5F5); // oklch(97% 0 0)
const Color _lMutedForeground = Color(0xFF636363); // oklch(50% 0 0)
const Color _lAccent = Color(0xFF00C5C7); // oklch(72% 0.18 195)
const Color _lAccentForeground = Color(0xFF0B0B0B); // oklch(15% 0 0)
const Color _lDestructive = Color(0xFFEE343B); // oklch(62% 0.22 25)
const Color _lBorder = Color(0x0F0B0B0B); // oklch(15% 0 0 / 0.06)
...
// ── Neutral base — dark ──────────────────────────────────────────
const Color _dBackground = Color(0xFF151515); // #151515
const Color _dForeground = Color(0xFFF2F2F2); // oklch(96% 0 0)
const Color _dCard = Color(0xFF1C1C1C); // #1c1c1c
const Color _dCardForeground = Color(0xFFF2F2F2); // oklch(96% 0 0)
const Color _dPopover = Color(0xFF1C1C1C); // #1c1c1c
const Color _dPopoverForeground = Color(0xFFF2F2F2); // oklch(96% 0 0)
const Color _dPrimary = Color(0xFFF2F2F2); // oklch(96% 0 0)
const Color _dPrimaryForeground = Color(0xFF151515); // #151515
const Color _dSecondary = Color(0xFF1C1C1C); // #1c1c1c
const Color _dSecondaryForeground = Color(0xFFF2F2F2); // oklch(96% 0 0)
const Color _dMuted = Color(0xFF1C1C1C); // #1c1c1c
const Color _dMutedForeground = Color(0xFF868686); // oklch(62% 0 0)
const Color _dAccent = Color(0xFF00DFE1); // oklch(80% 0.18 195)
const Color _dAccentForeground = Color(0xFF151515); // #151515
const Color _dDestructive = Color(0xFFEE343B); // oklch(62% 0.22 25)
const Color _dBorder = Color(0x0DFFFFFF); // rgb(255 255 255 / 0.05)
...
const _Brand _violetLight = _Brand(
  primary: Color(0xFF7552DB), // oklch(55% 0.2 290)
  primaryForeground: Color(0xFFFCFCFC), // oklch(99% 0 0)
...
const _Brand _violetDark = _Brand(
  ...
  primaryForeground: Color(0xFF0B0B0B), // oklch(15% 0 0)
...
const _Brand _amberLight = _Brand(
  ...
  primaryForeground: Color(0xFF1C140C), // oklch(20% 0.02 70)
...
const _Brand _amberDark = _Brand(
  ...
  primaryForeground: Color(0xFF171008), // oklch(18% 0.02 75)
...
const _Brand _limeLight = _Brand(
  ...
  primaryForeground: Color(0xFF101A05), // oklch(20% 0.04 130)
...
const _Brand _limeDark = _Brand(
  ...
  primaryForeground: Color(0xFF0C1503), // oklch(18% 0.04 130)
...
const Color _blueSwatch = Color(0xFF026FD7); // oklch(55% 0.18 255)
const Color _greenSwatch = Color(0xFF218A45); // oklch(56% 0.14 150)
const Color _amberSwatch = Color(0xFFE69825); // oklch(74% 0.15 70)
const Color _bloodOrangeSwatch = Color(0xFFD84A00); // oklch(60% 0.19 40)
const Color _roseSwatch = Color(0xFFD5305A); // oklch(58% 0.2 12)
const Color _redSwatch = Color(0xFFD40924); // oklch(55% 0.22 25)
const Color _tealSwatch = Color(0xFF00877B); // oklch(55% 0.12 185)
const Color _indigoSwatch = Color(0xFF484DD2); // oklch(50% 0.2 275)
const Color _limeSwatch = Color(0xFF7EBA27); // oklch(72% 0.18 130)
